<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enterprise.Master" CodeBehind="ValStock.aspx.vb" Inherits="EnterpriseTracking.ValStock" %>
...
function filtrado() {
  ...
  table = document.getElementById('<%= grdStocksVal.ClientID%>');
