<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enterprise.Master" CodeBehind="VtasxDistVend.aspx.vb" Inherits="EnterpriseTracking.VtasxDistVend" %>
...
<script>
  ...
  table = document.getElementById('<%= grdVentasDistVent.ClientID%>');
...
<div class="row" style="margin-top:15px;margin-bottom:15px">
    <div class="col-sm-8">
        <asp:Label ID="lblVtasxDistVendTitulo" runat="server" Text="Label" Width="100%" Font-Size="XX-Large" ></asp:Label>
    </div>
    <div class="col-sm-4">
...
<%--        <div class="row" style="margin-top:2px;margin-bottom:15px">
        ...
        <div class="row" style="margin-top:15px;">
            <div class="col-md-12">
                <asp:GridView ID="grdVentasDistVent" runat="server" CssClass="table table-bordered table-hover table-striped table-condensed" AutoGenerateColumns="False"  DataKeyNames="ID">
                    <Columns>
