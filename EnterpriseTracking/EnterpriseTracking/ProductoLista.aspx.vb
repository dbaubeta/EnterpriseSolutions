...
Public Class ProductoLista
    ...
    Protected Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevoProducto.Click
    ...
    Protected Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditarProducto.Click
        Dim l As New List(Of BE.ABM)
        Dim x As New BE.Cliente
        Dim hayerror As Boolean
        Dim p2 As New BLL.Persistencia(New BLL.Cliente)
        ...
        Try
            If Not IsNothing(grdProductos.SelectedRow) Then
                x.ID = dlClientes.SelectedValue
                l.Add(x)
                Session("ClientePadre") = DirectCast(p2.ObtenerLista(l)(0), BE.Cliente)
                Session(strClase + "AEditar") = grdProductos.SelectedRow.Cells(0).Text
            Else
                hayerror = True
            End If
        Catch bex As BE.Excepcion
    ...
    Protected Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminarProducto.Click
    ...
    Private Sub btnModalSi_ServerClick(sender As Object, e As EventArgs) Handles btnModalSi.ServerClick
        ...
        Try
            Dim cl As New BE.Producto
            Dim li As New List(Of BE.ABM)

            cl.ID = grdProductos.SelectedRow.Cells(0).Text
            li.Add(cl)
