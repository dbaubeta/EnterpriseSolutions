<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enterprise.Master" CodeBehind="GrupoLista.aspx.vb" Inherits="EnterpriseTracking.GrupoLista" %>
...
<div class="row" style="margin-top:15px;margin-bottom:15px">
    <div class="col-sm-12">
        <asp:Label ID="lblGrupoListaTitulo" runat="server" Text="Label" Width="100%" Font-Size="XX-Large" ></asp:Label>
    </div>
</div>
<hr />
...
<div class="row" style="margin-top:30px;height:100%;">
    ...
    <div class="col-md-10" style="height:100%">
        <div class="row" style="margin-top:30px;">
            <div class="col-md-9">
                <asp:GridView ID="grdGrupos" runat="server" CssClass="table table-bordered table-hover table-striped table-condensed" AutoGenerateColumns="False" >
                    <Columns>
            ...
            <div class="col-md-3">
                <%-- BOTONES ABM --%>
                <asp:Button ID="btnNuevoGrupo" runat="server" Text="Button" style="width:50%" CssClass="btn btn-primary" /> <br/><br/>
                <asp:Button ID="btnEditarGrupo" runat="server" Text="Button" style="width:50%" CssClass="btn btn-primary"/> <br/><br/>
                <asp:Button ID="btnEliminarGrupo" runat="server" Text="Button" style="width:50%" CssClass="btn btn-danger"/> <br/>
            </div>
        </div>
    </div>
    <div class="col-md-1" style="height:100%;min-height:200px"></div>
