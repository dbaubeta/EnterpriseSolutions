<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enterprise.Master" CodeBehind="ProductoEdicion.aspx.vb" Inherits="EnterpriseTracking.ProductoEdicion" %>
    ...
    <div class="col-sm-10" style="vertical-align:middle">
        ...
        <div class="row" style="margin-top:10px;margin-bottom:15px;">
            <div class="col-sm-2" style="padding-top:3px">
                <asp:Label ID="lblProductoID" runat="server" Text="Label" Width="100%" Font-Bold="true" style="text-align:right;"></asp:Label><br/>
            </div>    
            <div class="col-sm-3" style="padding-top:3px">
                <asp:Label ID="noTranslateProductoID" runat="server" Text="Label" Width="100%"></asp:Label>
            </div>        
        </div>
        <%-- LABEL + TEXTBOX --%>
        <div class="row" style="margin-top:10px" >
            ...
            <div class="col-sm-3" style="padding-top:3px">
                <asp:TextBox ID="txtIDRealProducto" runat="server" style="width:100%" CssClass="form-control" />
<%--                <asp:RequiredFieldValidator ID="RqFVtxtProductoNombre" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtProductoNombre" ></asp:RequiredFieldValidator>--%>
            </div>        
        </div>
        <%-- LABEL + TEXTBOX --%>
        <div class="row" style="margin-top:10px" >
            <div class="col-sm-2" style="padding-top:8px">
                <asp:Label ID="lblProductoNombre" runat="server" Text="Label" Font-Bold="true" Width="100%" style="text-align:right;"></asp:Label> <br/>
            </div>    
            <div class="col-sm-3" style="padding-top:3px">
                <asp:TextBox ID="txtProductoNombre" runat="server" style="width:100%" CssClass="form-control" />
<%--                <asp:RequiredFieldValidator ID="RqFVtxtProductoNombre" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtProductoNombre" ></asp:RequiredFieldValidator>--%>
            </div>        
        </div>
        <%-- LABEL + TEXTBOX --%>
        <div class="row" style="margin-top:10px" >
            <div class="col-sm-2" style="padding-top:8px">
                <asp:Label ID="lblPrecio" runat="server" Text="Label" Font-Bold="true" Width="100%" style="text-align:right;"></asp:Label> <br/>
            </div>    
            <div class="col-sm-3" style="padding-top:3px">
        ...
        <div class="row" style="margin-top:10px">
            <div class="col-sm-2" style="padding-top:8px">
                <asp:Label ID="lblProductoCategoria" runat="server" Text="Label" Width="100%" Font-Bold="true" style="text-align:right;"></asp:Label><br/>
            </div>    
            <div class="col-sm-3" style="padding-top:3px">
                <asp:DropDownList ID="dlCategorias" runat="server" CssClass="form-control"  AutoPostBack="False"></asp:DropDownList>
            </div>        
        </div>
