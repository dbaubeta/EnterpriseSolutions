<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enterprise.Master" CodeBehind="UsuarioAsignarPermisos.aspx.vb" Inherits="EnterpriseTracking.UsuarioAsignarPermisos" %>
    ...
    <div class="col-sm-10" style="vertical-align:middle">
        ...
        <div class="row" style="margin-top:10px" >
            ...
            <div class="col-sm-3" style="padding-top:3px">
                <asp:Label ID="noTranslatelblUsuarioNombre" runat="server" Text="Label" Font-Bold="true" Width="100%" style="text-align:right;"></asp:Label> <br/>
