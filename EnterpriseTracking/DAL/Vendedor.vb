    ...
    Public Sub Guardar(s As List(Of BE.Vendedor))
        ...
        Try
            ...
            For Each u As BE.Vendedor In s
    ...
    Public Function ObtenerVendedores(Optional f As List(Of BE.Vendedor) = Nothing) As List(Of BE.Vendedor)
        ...
        Dim in2 As String = ""
        Dim in3 As String = ""
        Dim cadena As String = "select * from vendedor where borrado = 0 "
        Dim idx1 As Integer = 0
        Dim idx2 As Integer = 0
        Dim idx3 As Integer = 0
        Dim dt As DataTable
        Dim l As BE.Vendedor
        Dim ll As New List(Of BE.Vendedor)
        ...
        Try
            ...
            If Not IsNothing(f) Then
                ...
                If f.Count > 0 Then
                    cadena = cadena + " and ("
                    For Each x As BE.Vendedor In f
