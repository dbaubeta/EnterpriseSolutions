Public Class Reportes
    ...
    Public Function Obtener_Ventas_TipoPDV(desde As BE.Factura, hasta As BE.Factura) As List(Of BE.Rep_Vtas_Dist_Vend)
        Try

            Return d.Obtener_Ventas_TipoPDV(desde, hasta)
